...
* [01 · 论文与研究问题](docs/01-SGD-Net学术论文.md)
* [32 · 融合评估与创新边界](docs/32-SGD-Net研究融合评估与创新边界20260912.md)
* [47 · 通用性与能力边界](docs/47-SGD-Net通用性审查与可构造模型覆盖方案20260912.md)

## 核心模型架构

* [36 · 统一架构与组件全集](docs/36-SGD-Net统一基础模型架构与组件单元全集20260912.md)
...
* [13 · 层与算子详解](docs/13-SGD-Net模型架构与层算子详解.md)
...
* [24 · 等变 GNN 与状态模型](docs/24-新Idea探讨_20260613_等变GNN与自进化架构.md)
* [18 · JEPA 与世界模型桥接](docs/18-SGD-Net与JEPA世界模型融合及JSBO桥梁算子.md)
* [33 · 拓扑接触世界模型提案](docs/33-SGD-Net-TC拓扑接触世界模型架构提案20260912.md)

## 数学、学习与持续演化

* [44 · 李亚普洛夫稳定性](docs/44-SGD-Net李亚普洛夫稳定性组件与领域适用条件20260912.md)
* [45 · 隐式求解](docs/45-SGD-Net隐式求解组件与训练推理路径20260912.md)
* [46 · 动态生长与持续演化](docs/46-SGD-Net先验后验驱动的动态生长与持续演化20260912.md)
* [48 · 函数空间与数值误差](docs/48-SGD-Net函数空间算子逼近与约束解空间评估20260912.md)
* [27 · 混合求解与训练](docs/27-SGD-Net混合求解训练体系与世界模型研究路线.md)
* [14 · 双闭环控制与认知类比](docs/14-SGD-Net双闭环控制与类脑认知架构.md)
* [17 · 复盘与自进化设计](docs/17-SGD-Net反省复盘与动态自进化机制.md)
* [50 · 反思、回顾与复盘](docs/50-SGD-Net反思回顾复盘的基础与闭环完善20260912.md)
* [25 · 物理约束与执行检查](docs/25-SGD-Harness物理守恒哨兵与等变自进化闭环.md)

## 领域模型与科学应用

* [35 · 跨领域扩展路线](docs/35-SGD-Net跨领域扩展路线与科研任务映射20260912.md)
* [37 · 世界模型](docs/37-SGD-Net世界模型构建详解20260912.md)
* [38 · 物理 AI 与灵巧手](docs/38-SGD-Net物理AI与灵巧手模型构建详解20260912.md)
* [39 · 制药与分子](docs/39-SGD-Net制药与分子模型构建详解20260912.md)
* [40 · 生物与细胞](docs/40-SGD-Net生物与细胞模型构建详解20260912.md)
* [41 · 材料](docs/41-SGD-Net材料模型构建详解20260912.md)
* [42 · 神经行为](docs/42-SGD-Net神经行为模型构建详解20260912.md)
* [43 · 信号与突触](docs/43-SGD-Net信号突触模型构建详解20260912.md)
* [07 · 科学大模型扩展](docs/07-SGD-Net赋能科学大模型专题.md)
* [08 · 科研 Agent 与材料筛选](docs/08-SGD-Net多模态科研Agent与材料自动筛选方案.md)
* [15 · 具身实验与数字孪生](docs/15-SGD-Ecosystem物理具身数字孪生与双向流形折叠.md)

## 实现与实验验证

* [03 · 实现技术白皮书](docs/03-Python实现技术白皮书.md)
* [04 · 实现概要设计](docs/04-Python实现概要设计.md)
* [05 · 实现详细设计](docs/05-Python实现详细设计.md)
* [34 · 跨本体验证与成本](docs/34-SGD-Net-TC验证方案与软硬件映射20260912.md)
* [49 · 任务卡与评估路线](docs/49-SGD-Net能力优先路线与数学评估任务卡20260912.md)
