...
| 内容 | 推荐入口 |
|---|---|
| 研究问题与论文方法 | [论文与研究问题](docs/01.md) |
| 统一组件与模型构建 | [统一架构与组件全集](docs/36.md) |
| 层、算子与实现细节 | [层与算子详解](docs/13.md) |
| 表达能力与误差分析 | [函数空间与数值误差](docs/48.md) |
| 动态生长与持续学习 | [动态生长与持续演化](docs/46.md) |
| 科学与物理 AI 应用 | [跨领域扩展路线](docs/35.md) |
| 可证伪实验与任务卡 | [任务卡与评估路线](docs/49.md) |
