...
更完整的自进化机制见 [SGD-Net反省复盘与动态自进化机制](17.md)。
...
| 文档 | 关系 |
|---|---|
| [SGD-Net模型架构与层算子详解](13.md) | 本文补充前馈预测、来源标签、知识分类等完全体模块 |
| [SGD-Net多模态科研Agent与材料自动筛选方案](08.md) | 本文的记忆/来源/知识分类机制可用于科研 Agent |
| [SGD-Ecosystem物理具身数字孪生与双向流形折叠](15.md) | 本文的待核实知识、预测控制和后验反馈在物理实验生态中闭环验证 |
| [SGD-Net反省复盘与动态自进化机制](17.md) | 本文的双闭环、多级记忆和知识分类在更长时间尺度上形成反省、动态整理和主动遗忘机制 |
| [SGD-Net与JEPA世界模型融合及JSBO桥梁算子](18.md) | 本文的梦境/离线整合机制可迁移为叙事创作模式，JEPA latent planning 可接入前馈预测但须后验保底 |
| [SGD-Net混合求解训练体系与世界模型研究路线](27.md) | 本文的控制闭环进一步扩展为混合求解、在线状态估计和 AMI 六模块启发式映射 |
...
[← 上一页](27.md) · [全书目录](../SUMMARY.md) · [下一页 →](17.md)
